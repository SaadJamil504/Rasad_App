...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#ffffff", borderRadius: 24, borderWidth: 1, borderColor: "#e5e7eb", padding: 30, alignItems: "center", marginBottom: 32 },
  currentInfo: { alignItems: "center", marginBottom: 30 },
  currentLabel: { fontSize: 12, fontWeight: "800", color: "#9ca3af", marginBottom: 8 },
  currentValue: { fontSize: 48, fontWeight: "800", color: "#000" },
  currentPrice: { fontSize: 14, color: "#6b7280", fontWeight: "500" },
  selectorContainer: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "100%", marginBottom: 20 },
  selectorButton: { width: 56, height: 56, borderRadius: 16, borderWidth: 1, borderColor: "#e5e7eb", justifyContent: "center", alignItems: "center" },
  quantityNumber: { fontSize: 64, fontWeight: "800", color: "#2563eb" },
  newPrice: { fontSize: 16, fontWeight: "700", color: "#2563eb" },
  inputGroup: { marginBottom: 32 },
  label: { fontSize: 14, fontWeight: "700", color: "#374151", marginBottom: 8 },
  dropdown: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderWidth: 1, borderColor: "#bfdbfe", borderRadius: 12, padding: 14, backgroundColor: "#f8fafc" },
  ...
  confirmButton: { backgroundColor: "#22c55e", borderRadius: 14, paddingVertical: 18, alignItems: "center" },
